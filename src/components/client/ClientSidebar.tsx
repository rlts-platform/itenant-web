...
const NAV = [
  ...
  { href: "/client/properties", label: "Properties", icon: "building" },
  { href: "/client/units", label: "Units", icon: "home" },
  { href: "/client/applications", label: "Applications", icon: "file-text" },
  { href: "/client/tenants", label: "Tenants", icon: "users" },
  { href: "/client/leases", label: "Leases", icon: "file-text" },
  { href: "/client/maintenance", label: "Maintenance", icon: "wrench" },
  { href: "/client/messages", label: "Messages", icon: "message-square" },
  { href: "/client/payments", label: "Payments", icon: "dollar-sign" },
  ...
  { href: "/client/ai", label: "AI Assistant", icon: "zap" },
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white border-r border-neutral-200 flex flex-col z-30">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-neutral-100">
        ...
        <span className="text-lg font-bold tracking-tight text-neutral-900">iTenant</span>
      </div>
      ...
      <div className="px-4 py-4 border-t border-neutral-100">
        <div className="text-xs text-neutral-400 text-center">iTenant by RLTS</div>
      </div>
    </aside>
  );
}
